...
const IDL = {
    ...
    metadata: {
        ...
        version: "0.1.0",
        spec: "0.1.0",
        description: "RedCircle Protocol - Tokenize and trade social media posts on Solana",
    },
    instructions: [
        {
            name: "buy",
    ...
    errors: [
        ...
        { code: 6033, name: "TokenSymbolTooLong", msg: "Token symbol too long" },
        { code: 6034, name: "TokenUriTooLong", msg: "Token URI too long" },
        ...
        },
        {
            ...
            type: {
                ...
                fields: [
                    ...
                    { name: "default_migration_threshold", type: "u64" },
        ...
        },
        {
            ...
            type: {
                ...
                fields: [
                    ...
                    { name: "migration_threshold", type: { option: "u64" } },
                ],
            },
        },
        {
            name: "CurveType",
            type: { kind: "enum", variants: [{ name: "ConstantProduct" }, { name: "Linear" }, { name: "Exponential" }] },
        },
        {
        ...
        },
        {
            ...
            type: {
                ...
                fields: [
                    ...
                    { name: "migration_threshold", type: "u64" },
                    { name: "total_volume", type: "u128" },
        ...
        },
        {
            ...
            type: {
                ...
                fields: [
                    ...
                    { name: "default_migration_threshold", type: { option: "u64" } },
                    { name: "pool_creation_fee", type: { option: "u64" } },
                    { name: "launch_protection_duration", type: { option: "i64" } },
                    { name: "max_buy_during_protection", type: { option: "u64" } },
                ],
