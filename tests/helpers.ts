...
export const client = new RedCircleClient(provider, {
...
export const growthRecipient = Keypair.generate();
...
export const [marketStatePda] = findMarketStatePda(poolPda, program.programId);
